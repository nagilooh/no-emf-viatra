/**
 */
package hu.bme.mit.inf.friends.util;
...
public class FriendsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected FriendsSwitch<Adapter> modelSwitch = new FriendsSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.bme.mit.inf.friends.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.bme.mit.inf.friends.People <em>People</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
