 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.friends.impl.PeopleImpl#getPerson <em>Person</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PeopleImpl extends MinimalEObjectImpl.Container implements People {
	...
	protected EClass eStaticClass() {
		return FriendsPackage.Literals.PEOPLE;
	}
	...
	public EList<Person> getPerson() {
		if (person == null) {
			person = new EObjectContainmentEList<Person>(Person.class, this, FriendsPackage.PEOPLE__PERSON);
		}
		return person;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case FriendsPackage.PEOPLE__PERSON:
