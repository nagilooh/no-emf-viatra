 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.friends.impl.PersonImpl#getFriend <em>Friend</em>}</li>
 *   <li>{@link hu.bme.mit.inf.friends.impl.PersonImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	 ...
	 * @generated
	 */
	public EList<Person> getFriend() {
		if (friend == null) {
			friend = new EObjectResolvingEList<Person>(Person.class, this, FriendsPackage.PERSON__FRIEND);
		}
		return friend;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case FriendsPackage.PERSON__FRIEND:
			return getFriend();
	...
	public void eSet(int featureID, Object newValue) {
		...
		case FriendsPackage.PERSON__FRIEND:
			getFriend().clear();
			getFriend().addAll((Collection<? extends Person>) newValue);
			return;
		case FriendsPackage.PERSON__NAME:
