...
public final class RelationConstraintTest extends BaseGeneratedEMFQuerySpecification<RelationConstraintTest.Matcher> {
  /**
   * Pattern-specific match representation of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.relationConstraintTest pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.eclipse.viatra.query.runtime.tabular.generic.test.queries.relationConstraintTest";
    }
    
    @Override
    public List<String> parameterNames() {
      return RelationConstraintTest.Match.parameterNames;
    }
    ...
    @Override
    public RelationConstraintTest.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RelationConstraintTest.Match)) {
          RelationConstraintTest.Match other = (RelationConstraintTest.Match) obj;
    ...
    @Override
    public RelationConstraintTest specification() {
     ...
     * 
     */
    public static RelationConstraintTest.Match newEmptyMatch() {
     ...
     * 
     */
    public static RelationConstraintTest.Match newMutableMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public static RelationConstraintTest.Match newMatch(final Person pP1, final Person pP2) {
      return new Immutable(pP1, pP2);
    }
    
    private static final class Mutable extends RelationConstraintTest.Match {
    ...
    private static final class Immutable extends RelationConstraintTest.Match {
  ...
  /**
   * Generated pattern matcher API of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.relationConstraintTest pattern,
   ...
   * 
   * @see Match
   * @see RelationConstraintTest
   * 
   */
  public static class Matcher extends BaseMatcher<RelationConstraintTest.Match> {
    /**
     ...
     * 
     */
    public static RelationConstraintTest.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RelationConstraintTest.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RelationConstraintTest.Matcher.class);
     ...
     * 
     */
    public Collection<RelationConstraintTest.Match> getAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Stream<RelationConstraintTest.Match> streamAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Optional<RelationConstraintTest.Match> getOneArbitraryMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Person pP1, final Person pP2, final Consumer<? super RelationConstraintTest.Match> processor) {
     ...
     * 
     */
    public RelationConstraintTest.Match newMatch(final Person pP1, final Person pP2) {
      return RelationConstraintTest.Match.newMatch(pP1, pP2);
    }
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp1(final RelationConstraintTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp1(final RelationConstraintTest.Match partialMatch) {
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp2(final RelationConstraintTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp2(final RelationConstraintTest.Match partialMatch) {
    ...
    @Override
    protected RelationConstraintTest.Match tupleToMatch(final Tuple t) {
      try {
          return RelationConstraintTest.Match.newMatch((Person) t.get(POSITION_P1), (Person) t.get(POSITION_P2));
    ...
    @Override
    protected RelationConstraintTest.Match arrayToMatch(final Object[] match) {
      try {
          return RelationConstraintTest.Match.newMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RelationConstraintTest.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RelationConstraintTest.Match.newMutableMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RelationConstraintTest.Matcher> querySpecification() {
      return RelationConstraintTest.instance();
    }
  }
  
  private RelationConstraintTest() {
   ...
   * 
   */
  public static RelationConstraintTest instance() {
    try{
  ...
  @Override
  protected RelationConstraintTest.Matcher instantiate(final ViatraQueryEngine engine) {
    return RelationConstraintTest.Matcher.on(engine);
  }
  
  @Override
  public RelationConstraintTest.Matcher instantiate() {
    return RelationConstraintTest.Matcher.create();
  }
  
  @Override
  public RelationConstraintTest.Match newEmptyMatch() {
    return RelationConstraintTest.Match.newEmptyMatch();
  }
  
  @Override
  public RelationConstraintTest.Match newMatch(final Object... parameters) {
    return RelationConstraintTest.Match.newMatch((hu.bme.mit.inf.friends.Person) parameters[0], (hu.bme.mit.inf.friends.Person) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RelationConstraintTest} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RelationConstraintTest#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RelationConstraintTest INSTANCE = new RelationConstraintTest();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RelationConstraintTest.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_p1, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.inf.mit.bme.hu/friends", "Person", "friend")));
          new TypeConstraint(body, Tuples.flatTupleOf(var__virtual_0_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.inf.mit.bme.hu/friends", "Person")));
