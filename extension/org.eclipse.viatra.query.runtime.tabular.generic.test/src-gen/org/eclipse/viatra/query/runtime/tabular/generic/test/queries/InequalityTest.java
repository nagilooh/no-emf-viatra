...
public final class InequalityTest extends BaseGeneratedEMFQuerySpecification<InequalityTest.Matcher> {
  /**
   * Pattern-specific match representation of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.inequalityTest pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.eclipse.viatra.query.runtime.tabular.generic.test.queries.inequalityTest";
    }
    
    @Override
    public List<String> parameterNames() {
      return InequalityTest.Match.parameterNames;
    }
    ...
    @Override
    public InequalityTest.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InequalityTest.Match)) {
          InequalityTest.Match other = (InequalityTest.Match) obj;
    ...
    @Override
    public InequalityTest specification() {
     ...
     * 
     */
    public static InequalityTest.Match newEmptyMatch() {
     ...
     * 
     */
    public static InequalityTest.Match newMutableMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public static InequalityTest.Match newMatch(final Person pP1, final Person pP2) {
      return new Immutable(pP1, pP2);
    }
    
    private static final class Mutable extends InequalityTest.Match {
    ...
    private static final class Immutable extends InequalityTest.Match {
  ...
  /**
   * Generated pattern matcher API of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.inequalityTest pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<InequalityTest.Match> {
    /**
     ...
     * 
     */
    public static InequalityTest.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InequalityTest.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InequalityTest.Matcher.class);
     ...
     * 
     */
    public Collection<InequalityTest.Match> getAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Stream<InequalityTest.Match> streamAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Optional<InequalityTest.Match> getOneArbitraryMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Person pP1, final Person pP2, final Consumer<? super InequalityTest.Match> processor) {
     ...
     * 
     */
    public InequalityTest.Match newMatch(final Person pP1, final Person pP2) {
      return InequalityTest.Match.newMatch(pP1, pP2);
    }
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp1(final InequalityTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp1(final InequalityTest.Match partialMatch) {
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp2(final InequalityTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp2(final InequalityTest.Match partialMatch) {
    ...
    @Override
    protected InequalityTest.Match tupleToMatch(final Tuple t) {
      try {
          return InequalityTest.Match.newMatch((Person) t.get(POSITION_P1), (Person) t.get(POSITION_P2));
    ...
    @Override
    protected InequalityTest.Match arrayToMatch(final Object[] match) {
      try {
          return InequalityTest.Match.newMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InequalityTest.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InequalityTest.Match.newMutableMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InequalityTest.Matcher> querySpecification() {
      return InequalityTest.instance();
    }
  }
   ...
   * 
   */
  public static InequalityTest instance() {
    try{
  ...
  @Override
  protected InequalityTest.Matcher instantiate(final ViatraQueryEngine engine) {
    return InequalityTest.Matcher.on(engine);
  }
  
  @Override
  public InequalityTest.Matcher instantiate() {
    return InequalityTest.Matcher.create();
  }
  
  @Override
  public InequalityTest.Match newEmptyMatch() {
    return InequalityTest.Match.newEmptyMatch();
  }
  
  @Override
  public InequalityTest.Match newMatch(final Object... parameters) {
    return InequalityTest.Match.newMatch((hu.bme.mit.inf.friends.Person) parameters[0], (hu.bme.mit.inf.friends.Person) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InequalityTest} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InequalityTest#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InequalityTest INSTANCE = new InequalityTest();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InequalityTest.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find relationConstraintTest(p1, p3)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_p1, var_p3), RelationConstraintTest.instance().getInternalQueryRepresentation());
          // 	find relationConstraintTest(p2, p3)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_p2, var_p3), RelationConstraintTest.instance().getInternalQueryRepresentation());
          // 	p1 != p2
