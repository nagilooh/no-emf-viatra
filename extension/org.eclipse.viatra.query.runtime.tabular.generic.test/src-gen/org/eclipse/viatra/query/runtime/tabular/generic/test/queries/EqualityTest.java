...
public final class EqualityTest extends BaseGeneratedEMFQuerySpecification<EqualityTest.Matcher> {
  /**
   * Pattern-specific match representation of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.equalityTest pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.eclipse.viatra.query.runtime.tabular.generic.test.queries.equalityTest";
    }
    
    @Override
    public List<String> parameterNames() {
      return EqualityTest.Match.parameterNames;
    }
    ...
    @Override
    public EqualityTest.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EqualityTest.Match)) {
          EqualityTest.Match other = (EqualityTest.Match) obj;
    ...
    @Override
    public EqualityTest specification() {
     ...
     * 
     */
    public static EqualityTest.Match newEmptyMatch() {
     ...
     * 
     */
    public static EqualityTest.Match newMutableMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public static EqualityTest.Match newMatch(final Person pP1, final Person pP2) {
      return new Immutable(pP1, pP2);
    }
    
    private static final class Mutable extends EqualityTest.Match {
    ...
    private static final class Immutable extends EqualityTest.Match {
  ...
  /**
   * Generated pattern matcher API of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.equalityTest pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EqualityTest.Match> {
    /**
     ...
     * 
     */
    public static EqualityTest.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EqualityTest.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EqualityTest.Matcher.class);
     ...
     * 
     */
    public Collection<EqualityTest.Match> getAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Stream<EqualityTest.Match> streamAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Optional<EqualityTest.Match> getOneArbitraryMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Person pP1, final Person pP2, final Consumer<? super EqualityTest.Match> processor) {
     ...
     * 
     */
    public EqualityTest.Match newMatch(final Person pP1, final Person pP2) {
      return EqualityTest.Match.newMatch(pP1, pP2);
    }
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp1(final EqualityTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp1(final EqualityTest.Match partialMatch) {
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp2(final EqualityTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp2(final EqualityTest.Match partialMatch) {
    ...
    @Override
    protected EqualityTest.Match tupleToMatch(final Tuple t) {
      try {
          return EqualityTest.Match.newMatch((Person) t.get(POSITION_P1), (Person) t.get(POSITION_P2));
    ...
    @Override
    protected EqualityTest.Match arrayToMatch(final Object[] match) {
      try {
          return EqualityTest.Match.newMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EqualityTest.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EqualityTest.Match.newMutableMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EqualityTest.Matcher> querySpecification() {
      return EqualityTest.instance();
    }
  }
  
  private EqualityTest() {
   ...
   * 
   */
  public static EqualityTest instance() {
    try{
  ...
  @Override
  protected EqualityTest.Matcher instantiate(final ViatraQueryEngine engine) {
    return EqualityTest.Matcher.on(engine);
  }
  
  @Override
  public EqualityTest.Matcher instantiate() {
    return EqualityTest.Matcher.create();
  }
  
  @Override
  public EqualityTest.Match newEmptyMatch() {
    return EqualityTest.Match.newEmptyMatch();
  }
  
  @Override
  public EqualityTest.Match newMatch(final Object... parameters) {
    return EqualityTest.Match.newMatch((hu.bme.mit.inf.friends.Person) parameters[0], (hu.bme.mit.inf.friends.Person) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EqualityTest} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EqualityTest#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EqualityTest.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	p1 == p2
          new Equality(body, var_p1, var_p2);
          bodies.add(body);
      }
      return bodies;
    }
