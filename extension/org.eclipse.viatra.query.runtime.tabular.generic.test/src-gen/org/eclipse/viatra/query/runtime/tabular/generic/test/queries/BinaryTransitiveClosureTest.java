...
public final class BinaryTransitiveClosureTest extends BaseGeneratedEMFQuerySpecification<BinaryTransitiveClosureTest.Matcher> {
  /**
   * Pattern-specific match representation of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.binaryTransitiveClosureTest pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.eclipse.viatra.query.runtime.tabular.generic.test.queries.binaryTransitiveClosureTest";
    }
    
    @Override
    public List<String> parameterNames() {
      return BinaryTransitiveClosureTest.Match.parameterNames;
    }
    ...
    @Override
    public BinaryTransitiveClosureTest.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BinaryTransitiveClosureTest.Match)) {
          BinaryTransitiveClosureTest.Match other = (BinaryTransitiveClosureTest.Match) obj;
    ...
    @Override
    public BinaryTransitiveClosureTest specification() {
     ...
     * 
     */
    public static BinaryTransitiveClosureTest.Match newEmptyMatch() {
     ...
     * 
     */
    public static BinaryTransitiveClosureTest.Match newMutableMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public static BinaryTransitiveClosureTest.Match newMatch(final Person pP1, final Person pP2) {
      return new Immutable(pP1, pP2);
    }
    
    private static final class Mutable extends BinaryTransitiveClosureTest.Match {
    ...
    private static final class Immutable extends BinaryTransitiveClosureTest.Match {
  ...
  /**
   * Generated pattern matcher API of the org.eclipse.viatra.query.runtime.tabular.generic.test.queries.binaryTransitiveClosureTest pattern,
   ...
   * 
   * @see Match
   * @see BinaryTransitiveClosureTest
   * 
   */
  public static class Matcher extends BaseMatcher<BinaryTransitiveClosureTest.Match> {
    /**
     ...
     * 
     */
    public static BinaryTransitiveClosureTest.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BinaryTransitiveClosureTest.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BinaryTransitiveClosureTest.Matcher.class);
     ...
     * 
     */
    public Collection<BinaryTransitiveClosureTest.Match> getAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Stream<BinaryTransitiveClosureTest.Match> streamAllMatches(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public Optional<BinaryTransitiveClosureTest.Match> getOneArbitraryMatch(final Person pP1, final Person pP2) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Person pP1, final Person pP2, final Consumer<? super BinaryTransitiveClosureTest.Match> processor) {
     ...
     * 
     */
    public BinaryTransitiveClosureTest.Match newMatch(final Person pP1, final Person pP2) {
      return BinaryTransitiveClosureTest.Match.newMatch(pP1, pP2);
    }
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp1(final BinaryTransitiveClosureTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp1(final BinaryTransitiveClosureTest.Match partialMatch) {
     ...
     * 
     */
    public Stream<Person> streamAllValuesOfp2(final BinaryTransitiveClosureTest.Match partialMatch) {
     ...
     * 
     */
    public Set<Person> getAllValuesOfp2(final BinaryTransitiveClosureTest.Match partialMatch) {
    ...
    @Override
    protected BinaryTransitiveClosureTest.Match tupleToMatch(final Tuple t) {
      try {
          return BinaryTransitiveClosureTest.Match.newMatch((Person) t.get(POSITION_P1), (Person) t.get(POSITION_P2));
    ...
    @Override
    protected BinaryTransitiveClosureTest.Match arrayToMatch(final Object[] match) {
      try {
          return BinaryTransitiveClosureTest.Match.newMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BinaryTransitiveClosureTest.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BinaryTransitiveClosureTest.Match.newMutableMatch((Person) match[POSITION_P1], (Person) match[POSITION_P2]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BinaryTransitiveClosureTest.Matcher> querySpecification() {
      return BinaryTransitiveClosureTest.instance();
    }
  }
  
  private BinaryTransitiveClosureTest() {
   ...
   * 
   */
  public static BinaryTransitiveClosureTest instance() {
    try{
  ...
  @Override
  protected BinaryTransitiveClosureTest.Matcher instantiate(final ViatraQueryEngine engine) {
    return BinaryTransitiveClosureTest.Matcher.on(engine);
  }
  
  @Override
  public BinaryTransitiveClosureTest.Matcher instantiate() {
    return BinaryTransitiveClosureTest.Matcher.create();
  }
  
  @Override
  public BinaryTransitiveClosureTest.Match newEmptyMatch() {
    return BinaryTransitiveClosureTest.Match.newEmptyMatch();
  }
  
  @Override
  public BinaryTransitiveClosureTest.Match newMatch(final Object... parameters) {
    return BinaryTransitiveClosureTest.Match.newMatch((hu.bme.mit.inf.friends.Person) parameters[0], (hu.bme.mit.inf.friends.Person) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link BinaryTransitiveClosureTest} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link BinaryTransitiveClosureTest#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BinaryTransitiveClosureTest INSTANCE = new BinaryTransitiveClosureTest();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BinaryTransitiveClosureTest.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find relationConstraintTest+(p1, p2)
          new BinaryTransitiveClosure(body, Tuples.flatTupleOf(var_p1, var_p2), RelationConstraintTest.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
